 ...
 */
$OAUTH2_CLIENT_ID = '336672653307-b32ode4o7lreqlcnctp43p45keoa8ged.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = 'aCiABgJ6uttvZVNTPWK5xkg3';
...
if ($client->getAccessToken()) {
    ...
    try {
        ...
        $list = array();
        array_push($list, 'UC0xBCDoQMtaWl1ZZz7WRFVw', 'UCpo83FKgEX5gGEcWZXpSJCw', 'UCqSMvNANwmfY55cwd3ISMMg');
        foreach ($list as $row){

            $resourceId = new Google_Service_YouTube_ResourceId();

            $resourceId->setChannelId(''.$row.'');
